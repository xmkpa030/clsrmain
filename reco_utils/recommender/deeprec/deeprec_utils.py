...
def create_hparams(flags):
    ...
    return tf.contrib.training.HParams(
        ...
        K_long=flags["K_long"] if "K_long" in flags else 2,
        K_short=flags["K_short"] if "K_short" in flags else 2,
        lambda_orth=flags["lambda_orth"] if "lambda_orth" in flags else 0.0,
