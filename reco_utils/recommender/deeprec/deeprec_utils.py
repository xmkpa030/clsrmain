...
def create_hparams(flags):
    ...
    return tf.contrib.training.HParams(
        ...
        long_proxy_type=flags["long_proxy_type"] if "long_proxy_type" in flags else "mean",
        long_proxy_decay_lambda=flags["long_proxy_decay_lambda"] if "long_proxy_decay_lambda" in flags else 0.05,
        long_proxy_update_beta=flags["long_proxy_update_beta"] if "long_proxy_update_beta" in flags else 0.3,
        long_proxy_update_window_size=flags["long_proxy_update_window_size"] if "long_proxy_update_window_size" in flags else 10,
